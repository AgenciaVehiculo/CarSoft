...
public class HistoricoCargo_empleadoJpaController implements Serializable {
    ...
    public HistoricoCargo_empleadoJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public boolean createTest(HistoricoCargo_empleado historicoCargo_empleado) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findHistoricoCargo_empleado(historicoCargo_empleado.getId_cargo_historico()) != null) {
    ...
    public boolean editTest(HistoricoCargo_empleado historicoCargo_empleado) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
