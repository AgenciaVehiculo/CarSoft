...
public class Cargo_empleadoJpaController implements Serializable {
    ...
    public Cargo_empleadoJpaController(EntityManagerFactory emf) {
        this.emf= emf; 
    }
    ...
    public void create(Cargo_empleado cargo_empleado) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(Cargo_empleado cargo_empleado) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
            //em = getEntityManager();
            //em.getTransaction().begin();
    ...
    public boolean editTest(Cargo_empleado cargo_empleado) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            /*em = getEntityManager();
            em.getTransaction().begin();
