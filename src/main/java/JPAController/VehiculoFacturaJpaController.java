...
public class VehiculoFacturaJpaController implements Serializable {
    ...
    public VehiculoFacturaJpaController(EntityManagerFactory emf) {
        this.emf= emf;
    }
    ...
    public boolean createTest(VehiculoFactura vehiculoFactura) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findVehiculoFactura(vehiculoFactura.getIdVehiculo()) != null) {
   ...
   public boolean editTest(VehiculoFactura vehiculoFactura) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
