...
public class BancoJpaController implements Serializable {
    ...
    public boolean createTest(Banco banco) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
            //em = getEntityManager();
            //em.getTransaction().begin();
    ...
    public boolean editTest(Banco banco) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            //em = getEntityManager();
            //em.getTransaction().begin();
