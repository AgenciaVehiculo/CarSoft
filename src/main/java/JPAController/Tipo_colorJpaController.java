...
public class Tipo_colorJpaController implements Serializable {
    ...
    public Tipo_colorJpaController(EntityManagerFactory emf) {
        this.emf= emf;
    }
    ...
    public void create(Tipo_color tipo_color) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(Tipo_color tipo_color) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findTipo_color(tipo_color.getId_tipo_color()) != null) {
    ...
    public void edit(Tipo_color tipo_color) throws NonexistentEntityException, Exception {
        ...
        public boolean editTest(Tipo_color tipo_color) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
