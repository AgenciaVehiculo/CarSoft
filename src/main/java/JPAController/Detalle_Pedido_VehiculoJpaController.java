...
public class Detalle_Pedido_VehiculoJpaController implements Serializable {
    ...
    public Detalle_Pedido_VehiculoJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public boolean createTest(Detalle_Pedido_Vehiculo detalle_Pedido_Vehiculo) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findDetalle_Pedido_Vehiculo(detalle_Pedido_Vehiculo.getId_pedido()) != null) {
    ...
    public void edit(Detalle_Pedido_Vehiculo detalle_Pedido_Vehiculo) throws NonexistentEntityException, Exception {
        ...
        public boolean editTest(Detalle_Pedido_Vehiculo detalle_Pedido_Vehiculo) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
