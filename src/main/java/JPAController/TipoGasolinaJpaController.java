...
public class TipoGasolinaJpaController implements Serializable {
    ...
    public TipoGasolinaJpaController(EntityManagerFactory emf) {
        this.emf= emf;
    }
    ...
    public void create(TipoGasolina tipoGasolina) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(TipoGasolina tipoGasolina) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findTipoGasolina(tipoGasolina.getIdTipoGasolina()) != null) {
    ...
    public void edit(TipoGasolina tipoGasolina) throws NonexistentEntityException, Exception {
        ...
        public boolean editTest(TipoGasolina tipoGasolina) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
