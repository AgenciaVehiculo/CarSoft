...
public class transmisionJpaController implements Serializable {
    ...
    public boolean createTest(transmision transmision) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findtransmision(transmision.getId_transmision()) != null) {
    ...
    public boolean editTest(transmision transmision) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
