...
public class VehiculoJpaController implements Serializable {
    ...
    public boolean createTest(Vehiculo vehiculo) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findVehiculo(vehiculo.getId_vehiculo()) != null) {
    ...
    public boolean editTest(Vehiculo vehiculo) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
