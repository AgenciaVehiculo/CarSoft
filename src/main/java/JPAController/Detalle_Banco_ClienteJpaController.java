...
public class Detalle_Banco_ClienteJpaController implements Serializable {
    ...
    public void create(Detalle_Banco_Cliente detalle_Banco_Cliente) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(Detalle_Banco_Cliente detalle_Banco_Cliente) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findDetalle_Banco_Cliente(detalle_Banco_Cliente.getNumero_prestamo()) != null) {
   ...
   public boolean editTest(Detalle_Banco_Cliente detalle_Banco_Cliente) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
