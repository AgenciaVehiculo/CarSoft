...
public class HistoricoPrecioVehiculosJpaController implements Serializable {
    ...
    public HistoricoPrecioVehiculosJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(HistoricoPrecioVehiculos historicoPrecioVehiculos) {
        ...
        public boolean createTest(HistoricoPrecioVehiculos historicoPrecioVehiculos) {
        EntityManager em = null;
        try {
        } finally {
            if (em != null) {
    ...
    public boolean editTest(HistoricoPrecioVehiculos historicoPrecioVehiculos) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
