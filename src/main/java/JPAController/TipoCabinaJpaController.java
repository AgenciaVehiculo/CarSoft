...
public class TipoCabinaJpaController implements Serializable {
    ...
    public TipoCabinaJpaController(EntityManagerFactory emf) {
        this.emf= emf;
    }
    ...
    public void create(TipoCabina tipoCabina) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(TipoCabina tipoCabina) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findTipoCabina(tipoCabina.getIdTipoCabina()) != null) {
    ...
    public void edit(TipoCabina tipoCabina) throws NonexistentEntityException, Exception {
        ...
        public boolean editTest(TipoCabina tipoCabina) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
