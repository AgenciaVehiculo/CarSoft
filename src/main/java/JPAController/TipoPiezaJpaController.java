...
public class TipoPiezaJpaController implements Serializable {
   ...
   /* public void create(TipoPieza tipoPieza) {
    ...
    public boolean createTest(TipoPieza tipoPieza) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findTipoPieza(tipoPieza.getIDtipopieza()) != null) {
    ...
    public boolean editTest(TipoPieza tipoPieza) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
