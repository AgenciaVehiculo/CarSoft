...
public class MarcaJpaController implements Serializable {
    ...
    public void create(Marca marca) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(Marca marca) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findMarca(marca.getIdMarca()) != null) {
    ...
    public boolean editTest(Marca marca) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
