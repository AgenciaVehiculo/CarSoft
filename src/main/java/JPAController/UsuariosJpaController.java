...
public class UsuariosJpaController implements Serializable {
    ...
    public void create(Usuarios usuarios) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(Usuarios usuarios) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findUsuarios(usuarios.getId_Usuario()) != null) {
   ...
   public boolean editTest(Usuarios usuarios) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
