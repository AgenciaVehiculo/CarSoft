...
public class HistoricoSueldo_empleadoJpaController implements Serializable {
   ...
   public boolean createTest(HistoricoSueldo_empleado historicoSueldo_empleado) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
    ...
    public boolean editTest(HistoricoSueldo_empleado historicoSueldo_empleado) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
