...
public class informacionFiscalJpaController implements Serializable {
    ...
    public void create(informacionFiscal informacionFiscal) throws PreexistingEntityException, Exception {
        ...
        public boolean createTest(informacionFiscal informacionFiscal) throws PreexistingEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            if (findinformacionFiscal(informacionFiscal.getIdInf()) != null) {
    ...
    public boolean editTest(informacionFiscal informacionFiscal) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
        } catch (Exception ex) {
            String msg = ex.getLocalizedMessage();
