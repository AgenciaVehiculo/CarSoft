...
public void btnActivarDesactivarCliente(){
    ...
    try{
        ...
        try {
                ...
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteAgregar"+fecha1+".log");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmCliente.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteModificar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        try{
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmCliente.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteLimpiar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnDesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesactivarActionPerformed
        ...
        DesactivarCliente();
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmCliente.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteDesactivar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnAgregar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregar1ActionPerformed
        try{
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmCliente.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"TipoDocumentoAgregar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnBuscar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscar2ActionPerformed
        ...
        BuscarClienteDocumento();
            ...
            try {
                ...
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteBuscar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnImprimirReporteExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirReporteExcelActionPerformed
        try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmBanco.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteReporteExcel"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnImprimirReportePdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirReportePdfActionPerformed
        try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmBanco.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ClienteReportePDF"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnImprimirReportePdf1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirReportePdf1ActionPerformed
       ...
       try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmCliente.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"TipoDocumentoReportePDF"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnImprimirReporteExcel1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirReporteExcel1ActionPerformed
        try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmCliente.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"TipoDocumentoReporteExcel"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
