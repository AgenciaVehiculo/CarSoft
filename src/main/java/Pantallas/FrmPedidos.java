        ...
        for(int i=a;i>=0;i--){
            ...
            try {
               ...
               fecha1 = aux1+""+aux2+""+aux3+"-"+fecha.get(Calendar.HOUR_OF_DAY)+""+fecha.get(Calendar.MINUTE)+""+fecha.get(Calendar.SECOND);
                Logger logger = Logger.getLogger(FrmPedidos.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"PedidosLimpiar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
...
//        btnActivarDesactivarPedido();
        btnDesactivar.setEnabled(false);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmPedidos.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ListaPedidosDesactivar"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmPedidos.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ListaPedidosReportePDF"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmPedidos.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"ListaPedidosReporteExcel"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
