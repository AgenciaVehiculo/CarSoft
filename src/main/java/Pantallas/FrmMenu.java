    ...
    private void btnVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVentasActionPerformed
        ...
        v.setVisible(true);
            ...
            try {
                ...
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirVentas"+fecha1+".log");
    ...
    private void btnCerrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCerrarActionPerformed
        ...
        this.setVisible(false);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmMenu.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuCerrarSesion"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClientesActionPerformed
        ...
        m.setVisible(true);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmMenu.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirCliente"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnPiezasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPiezasActionPerformed
        ...
        m.setVisible(true);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmMenu.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirPieza"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnEmpleadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmpleadosActionPerformed
        ...
        m.setVisible(true);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmMenu.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirEmpleado"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnVehículosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVehículosActionPerformed
        ...
        v.setVisible(true);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmMenu.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirVehiculos"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnBancosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBancosActionPerformed
        ...
        b.setEmpNomb(labelEmple1.getText());
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmMenu.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirBanco"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPedidosActionPerformed
        ...
        p.setVisible(true);
            ...
            try {
                ...
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirPedidos"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
    ...
    private void btnSeguridadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeguridadActionPerformed
        ...
        p.setVisible(true);
            ...
            try {
                ...
                Logger logger = Logger.getLogger(FrmEmpleados.class.getName());
                FileHandler fh = null;
                fh = new FileHandler("./"+"MenuAbrirSeguridad"+fecha1+".log");
                logger.addHandler(fh);
                fh.setFormatter(new SimpleFormatter());
                logger.setLevel(Level.WARNING);
                logger.log(Level.SEVERE,e.getMessage());
