    ...
    public ModalBanco(java.awt.Frame parent, boolean modal) {
     ...
     private void crearTableBusquedaCliente(){
         if("".equals(txtNombreBusqueda.getText().trim())){
            JOptionPane.showMessageDialog(null, "El campo para la Búsqueda del Banco esta vacío","Error!", JOptionPane.ERROR_MESSAGE);
            return;
        }
        else{
        }
        ...
        if(!bandera){
            JOptionPane.showMessageDialog(null,"No se encontro ningún Banco","Error!", JOptionPane.ERROR_MESSAGE);
        }   
    }
