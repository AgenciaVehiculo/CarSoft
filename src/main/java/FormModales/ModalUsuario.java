...
public class ModalUsuario extends javax.swing.JDialog {
    ...
    public ModalUsuario(java.awt.Frame parent, boolean modal) {
     ...
     private void crearTableBusquedaCliente(){
         if("".equals(txtNombreBusqueda.getText().trim())){
            JOptionPane.showMessageDialog(null, "El campo para la Búsqueda del Usuario esta vacío","Error!", JOptionPane.ERROR_MESSAGE);
            return;
        }
        else{
        }
        ...
        for(Usuarios tp : temp2){
                ...
                if(tp.getId_Nombre().equalsIgnoreCase(txtNombreBusqueda.getText())){
                    for(Acceso tpp : temp){
        ...
        if(!bandera){
            JOptionPane.showMessageDialog(null,"No se encontro ningún Usuario","Error!", JOptionPane.ERROR_MESSAGE);
        }   
    }
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(50, 270, 590, 200);

        jLabel17.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Búsqueda de Usuarios");
        jPanel3.add(jLabel17);
        jLabel17.setBounds(550, 10, 310, 35);
