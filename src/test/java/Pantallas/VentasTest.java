...
//    }
    ...
    public void testImprimirFacturaBusquedaTest() throws Exception {
        ...
        Factura f = new FacturaJpaController(emf).findFactura(2);
        Ventas instance;
        instance = new Ventas();
    ...
    public void testBtnImprimirFacturaActionPerfomedTest() {
        ...
        String txtDocumentoCliente = "0301199900002";
...
//    }
    ...
    /**
     * Test of setCmbEmpleado method, of class Ventas.
     */
//    @Test
//    public void testSetCmbEmpleado() {
//        System.out.println("setCmbEmpleado");
//        int valor = 0;
//        Ventas instance = new Ventas();
//        instance.setCmbEmpleado(valor);
//        // TODO review the generated test code and remove the default call to fail.
//        fail("The test case is a prototype.");
//    }
