...
public class Detalle_Banco_ClienteJpaControllerTest {
    ...
    public void testCreateTest() throws Exception {
        ...
        boolean result = instance.createTest(detalle_Banco_Cliente);
        try{
    ...
    public void testEditTest() throws Exception {
        ...
        detalle_Banco_Cliente.setEstado(true);
        detalle_Banco_Cliente.setFecha_inicio("2021-01-01");
        detalle_Banco_Cliente.setFecha_final("2022-01-04");
         boolean expResult=true;
        boolean result = instance.editTest(detalle_Banco_Cliente);
        try{
        assertEquals(expResult, result);
        }catch(Exception e){
        fail("The test case is a prototype.");
